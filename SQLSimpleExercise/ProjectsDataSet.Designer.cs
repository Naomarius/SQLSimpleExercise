...
namespace SQLSimpleExercise {
    ...
    public partial class ProjectsDataSet : global::System.Data.DataSet {
        ...
        public partial class ProjectsDataTable : global::System.Data.TypedTableBase<ProjectsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ProjectsRow AddProjectsRow(string ProjectName, int PercentComplete) {
        ...
        public partial class ProjectsRow : global::System.Data.DataRow {
            ...
            public int PercentComplete {
                get {
                    try {
                        return ((int)(this[this.tableProjects.PercentCompleteColumn]));
                    }
...
namespace SQLSimpleExercise.ProjectsDataSetTableAdapters {
    ...
    public partial class ProjectsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Projects] WHERE (([ID] = @Original_ID) AND ([ProjectName] = @O" +
                "riginal_ProjectName) AND ((@IsNull_PercentComplete = 1 AND [PercentComplete] IS " +
                "NULL) OR ([PercentComplete] = @Original_PercentComplete)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Projects] ([ProjectName], [PercentComplete]) VALUES (@ProjectN" +
                "ame, @PercentComplete);\r\nSELECT ID, ProjectName, PercentComplete FROM Projects W" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Projects] SET [ProjectName] = @ProjectName, [PercentComplete] = @PercentComplete WHERE (([ID] = @Original_ID) AND ([ProjectName] = @Original_ProjectName) AND ((@IsNull_PercentComplete = 1 AND [PercentComplete] IS NULL) OR ([PercentComplete] = @Original_PercentComplete)));
SELECT ID, ProjectName, PercentComplete FROM Projects WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SQLSimpleExercise.Properties.Settings.Default.ProjectsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, ProjectName, PercentComplete FROM dbo.Projects";
        ...
        public virtual int Delete(int Original_ID, string Original_ProjectName, global::System.Nullable<int> Original_PercentComplete) {
            ...
            if ((Original_PercentComplete.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_PercentComplete.Value));
            }
            else {
        ...
        public virtual int Insert(string ProjectName, global::System.Nullable<int> PercentComplete) {
            if ((ProjectName == null)) {
            ...
            if ((PercentComplete.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((int)(PercentComplete.Value));
            }
            else {
        ...
        public virtual int Update(string ProjectName, global::System.Nullable<int> PercentComplete, int Original_ID, string Original_ProjectName, global::System.Nullable<int> Original_PercentComplete, int ID) {
            if ((ProjectName == null)) {
                throw new global::System.ArgumentNullException("ProjectName");
            }
            else {
            ...
            if ((PercentComplete.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(PercentComplete.Value));
            }
            else {
            ...
            if ((Original_PercentComplete.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_PercentComplete.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ProjectName, global::System.Nullable<int> PercentComplete, int Original_ID, string Original_ProjectName, global::System.Nullable<int> Original_PercentComplete) {
            return this.Update(ProjectName, PercentComplete, Original_ID, Original_ProjectName, Original_PercentComplete, Original_ID);
        }
    }
